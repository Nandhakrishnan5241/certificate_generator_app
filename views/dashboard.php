...
<html lang="en">
  <head>
    ...
    <title>Certificate Generator | CERRT | SemiKolan</title>
    <link rel="stylesheet" href="<?php echo base_url('modules/certificate/assets/style.css'); ?>" />
    ...
    />
    <script src="<?php echo base_url('modules/certificate/vendor/joystick.js'); ?>"></script>
  ...
  <body>
    ...
    <script src="<?php echo base_url('modules/certificate/assets/script.js'); ?>"></script>
